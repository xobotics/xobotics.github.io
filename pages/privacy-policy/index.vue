<template>
  <div class="container container-mx mx-auto mt-60 text-color">
    ...
    <p>
      At xobotics.io, accessible from xobotics.io, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by xobotics.io and how we
      use it.
    </p>
    ...
    <p>
      ...
      and/or collect in xobotics.io. This policy is not applicable to any
    ...
    <p>
      xobotics.io follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, xobotics.io uses 'cookies'. These cookies are used
    ...
    <P
      ...
      advertising partners of xobotics.io.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on xobotics.io, which are sent
    ...
    <p>
      Note that xobotics.io has no access to or control over these cookies that
    ...
    <p>
      xobotics.io's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      xobotics.io does not knowingly collect any Personal Identifiable
