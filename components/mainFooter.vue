<template>
  <div>
    <footer class="af a2E a1J[120px]" id="footer-section">
      <div class="ae">
        <div class="ag aa a1L" style="justify-content: space-around">
          <div class="ab ak md:a1M/2 lg:a1U/12 xl:a1U/12">
            <div
              class="wow fadeInUp a2_ aH[330px] xl:a30"
              data-wow-delay="0s"
              style="
                visibility: visible;
                animation-delay: 0s;
            ...
            >
              <a
                href="https://crypto-tailwind.preview.uideck.com/index.html"
                class="a2a a2i"
              >
                <img
          ...
          <div class="ab ak sm:a1M/2 md:a1M/2 lg:a1U/12 xl:a12/12">
            ...
            >
              ...
              <div class="a34">
                ...
                <a
                  href="https://www.facebook.com/xobotics"
                  target="_blank"
                  class="an a1F a1R aQ hover:aR dark:aS dark:hover:aR"
                >
                  Facebook Page
        ...
        >
          <p class="a1F a1R a4u aQ dark:aS">
            Copyright © Xobotics - all Rights Reserved
          </p>
        </div>
      </div>
